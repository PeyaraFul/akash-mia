          ...
          {projects.map((project) => (
            ...
            >
              <div className="relative h-52 overflow-hidden">
                ...
                />
                <span className="absolute top-3 left-3 px-3 py-1 text-xs font-semibold rounded-full bg-blue-600/80 backdrop-blur-sm text-white shadow-lg">
                  {project.category}
                </span>
                <span className="absolute top-3 right-3 px-3 py-1 text-xs font-semibold rounded-full bg-green-500/80 backdrop-blur-sm text-white shadow-lg">
                  {project.status}
                </span>
              </div>
